...
namespace Wumpus_MasterProject_Ver1
{
    ...
    class Movement
    {
        ...
        public void MoveBetweenRoom(Room currentRoom, object sender, KeyEventArgs e) {
            ...
            else
            {
                ...
                {
                    case Keys.Left:
                        //Player moves to room to the left
                        break;
                    case Keys.Right:
                        //Player moves to room to the right
                        break;
                    case Keys.Up:
                        //Player moves to room in front
                        break;
                    case Keys.Down:
                        //Player moves to room behind
                        break;
                }
            }
        }
