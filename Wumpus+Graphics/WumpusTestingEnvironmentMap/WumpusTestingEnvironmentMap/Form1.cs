...
namespace WumpusTestingEnvironmentMap
{
    public partial class Form1 : Form
    {
        ...
        public void Start()
        {
            mapInstance = new Map(5, 5, 6, 6, 100);
            mapInstance.generate();
            mapInstance.addDoors();
            room = mapInstance.getMap()[2, 2];
            playerInstance = new Player(room, 3, 0, 0, mapInstance);
       }
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            switch (keyData)
            {
                case Keys.Space:
                    {
                        Draw(mapInstance, room, playerInstance);
                        return true;
                    }
                case Keys.Up:
                    {
                        playerInstance.moveInDirection();
                        Draw(mapInstance, room, playerInstance);
                        return true;
                    }
                ...
                case Keys.Right:
                    {
                        playerInstance.rotateInDirection(1);
                        Draw(mapInstance, room, playerInstance);
                        return true;
                    }
                case Keys.Left:
        ...
        private void Draw(Map mapInstance, Room startingRoom, Player playerInstance)
        {
            Random rnd = new Random();
            Console.WriteLine(rnd.Next(1, 1000));
            Console.WriteLine("Room:" + playerInstance.getPosition().number);
            Console.WriteLine("Dir:" + playerInstance.getDirection());
            ...
            Image hexImage = Image.FromFile(@"F:\People Screaming in Pain\Round1\Floor.png");
            Image play0 = Image.FromFile(@"F:\People Screaming in Pain\Round1\Floor.png");
            Image play1 = Image.FromFile(@"F:\People Screaming in Pain\Round1\Floor.png");
            Image play2 = Image.FromFile(@"F:\People Screaming in Pain\Round1\Floor.png");
            Image play3 = Image.FromFile(@"F:\People Screaming in Pain\Round1\Floor.png");
            Image play4 = Image.FromFile(@"F:\People Screaming in Pain\Round1\Floor.png");
            Image play5 = Image.FromFile(@"F:\People Screaming in Pain\Round1\Floor.png");
            ...
            for (int i = 0; i < mapInstance.getMap().GetLength(0); i++)
            {
                for (int j = 0; j < mapInstance.getMap().GetLength(1); j++)
                {
                    if (i % 2 == 0)
                    {
                        ...
                        {
                            switch (playerInstance.getDirection())
                            {
                                case 0:
                                    formGraphics.DrawImage(play0, i * 40 + 2, j * 40 + 2);
                                    break;
                                case 1:
                                    formGraphics.DrawImage(play1, i * 40 + 2, j * 40 + 2);
                                    break;
                                case 2:
                                    formGraphics.DrawImage(play2, i * 40 + 2, j * 40 + 2);
                                    break;
                                case 3:
                                    formGraphics.DrawImage(play3, i * 40 + 2, j * 40 + 2);
                                    break;
                                case 4:
                                    formGraphics.DrawImage(play4, i * 40 + 2, j * 40 + 2);
                                    break;
                                case 5:
                                    formGraphics.DrawImage(play5, i * 40 + 2, j * 40 + 2);
                                    break;
                            }
                        }
                        else
                        {
                            formGraphics.DrawImage(hexImage, i * 40 + 2, j * 40 + 2);
                    ...
                    else
                    {
                        if (playerInstance.getPosition().Equals(mapInstance.getMap()[i, j]))
                        {
                            ...
                            {
                                case 0:
                                    formGraphics.DrawImage(play0, i * 40 + 2, j * 40 + 22);
                                    break;
                                case 1:
                                    formGraphics.DrawImage(play1, i * 40 + 2, j * 40 + 22);
                                    break;
                                case 2:
                                    formGraphics.DrawImage(play2, i * 40 + 2, j * 40 + 22);
                                    break;
                                case 3:
                                    formGraphics.DrawImage(play3, i * 40 + 2, j * 40 + 22);
                                    break;
                                case 4:
                                    formGraphics.DrawImage(play4, i * 40 + 2, j * 40 + 22);
                                    break;
                                case 5:
                                    formGraphics.DrawImage(play5, i * 40 + 2, j * 40 + 22);
                                    break;
                            }
                        }
                        else
                        {
                            formGraphics.DrawImage(hexImage, i * 40 + 2, j * 40 + 22);
        ...
        private void playerMove(Player playerInstance, Map mapInstance, int directionChange, bool isMoving)
        {
            if (isMoving == true)
            {
                ...
                Draw(mapInstance, playerInstance.getPosition(), playerInstance);
            }
        }
    ...
    public class Player
    {
        ...
        public void moveInDirection() // This version of moveInDirection moves the player forward.
        {

            // Call method in Map object to see if moving that direction is possible:
            Room newPosition = mapInstance.calculateMovement(position, direction);
        ...
        public void moveInDirection(int moveDirection) // This version of moveInDirection allows the player to move in an arbitrary direction regardless of facing direction.
        {
            // Call method in Map object to see if moving that direction is possible:
        ...
        public void rotateInDirection(int rotateDirection) // -1 means rotate left, 1 means rotate right
        {
